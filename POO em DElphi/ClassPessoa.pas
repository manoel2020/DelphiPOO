...
type
   TPessoa = class
      ...
      public
         ...
         //permite escrever metodos com nome iguais, que recebem valores diferentes.
         function Receber(nome:String):String; overload;
         //Virtual - Indica que esse metodo pode ser reescrito em outras classes;
         //Porem ele obriga vc a imprementar ela nessa classe.
         function RetornaNome:String; virtual;
         //Abstract - Nesse metodo estou dizendo que ele pode ser reescrito
         //em outras classes, porem com o abstract tira a obrigatóriedade de
         //imprementar ele nessa Classe.
...
begin
   if(value = '')then
      raise Exception.Create('O Valor Não pode ser Vazio');
   FNome := Value;
end;
